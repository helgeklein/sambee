...
def init_db() -> None:
    ...
    from app.models.recent_directory import RecentDirectory  # noqa: F401 - Required for table creation
    ...
    from app.models.transfer_operation import TransferOperation  # noqa: F401 - Required for table creation
