...
All test images are generated by `scripts/setup-test-images`:
...
See `scripts/setup-test-images` for the complete implementation.
...
1. **Update generation script**: Edit `scripts/setup-test-images`
