...
- Keep companion Tauri JavaScript packages and Rust crates on matching major.minor versions. Validate dependency update PRs with `/usr/bin/python3 scripts/check_tauri_version_alignment.py`.
