...
export const EN_TRANSLATIONS = {
  ...
  fileBrowser: {
    ...
    archive: {
      ...
      extractPrompt: "<item>{{archive}}</item> will be extracted to:",
      extractMemberPrompt: "<item>{{member}}</item> will be extracted to:",
      extractMembersPrompt_one: "1 selected item will be extracted to:",
      extractMembersPrompt_other: "{{count}} selected items will be extracted to:",
