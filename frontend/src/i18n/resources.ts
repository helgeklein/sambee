...
export const EN_TRANSLATIONS = {
  ...
  settings: {
    ...
    aboutPage: {
      ...
      databaseValue: "SQLite {{version}}",
      copyAriaLabel: "Copy about information",
      copyTooltip: "Copy about information",
    ...
    userManagement: {
      ...
      editor: {
        ...
        usernameLabel: "Username",
        usernameHelp: "Used to sign in and uniquely identify the account.",
        nameLabel: "Full name",
        nameHelp: "Use the person's full name as they want it displayed in Sambee.",
        emailLabel: "Email",
        emailHelp: "Optional. Record an email address for this account.",
        roleLabel: "Role",
        roleHelp: "Admins manage settings and users. Editors can modify content. Viewers can browse content.",
        oidcRoleAssignmentHelp: "Optional. Overrides the role assigned by the configured OIDC policy for this account.",
        expiresAtLabel: "Expiration Time",
        expiresAtHelp: "Leave blank if this account should not expire.",
        accountActiveLabel: "Account is active",
        accountActiveHelp: "Disabled accounts cannot sign in or access Sambee.",
        ...
        requirePasswordChangeHelp: "The user must choose a new password when they next sign in.",
      },
      resetPasswordEditor: {
