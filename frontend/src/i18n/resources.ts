...
export const EN_TRANSLATIONS = {
  ...
  fileBrowser: {
    ...
    toolbar: {
      ...
      newFile: "New file",
      upload: "Upload",
      uploadChoiceFiles: "Files",
      uploadChoiceFolder: "Folder",
    ...
    transfers: {
      ...
      dropBusy: "Finish the current upload first",
      dropUnsupported: "Folder drops are unavailable in this browser. Use Upload instead",
      ...
      uploadDestinationChanged: "Upload cancelled because the destination changed. Choose a folder and try again.",
      uploadInspectDestination: "Outcome uncertain. Inspect the destination before retrying",
      uploadFolders: "{{created}} folders created, {{merged}} merged, {{skipped}} skipped",
      uploadPartial: "Upload cancelled. Files and folders already transferred remain at the destination.",
      uploadFolderFailed_one: "{{count}} folder failed",
    ...
    overwriteConflict: {
      ...
      folderConflict: "An item blocks this incoming folder. Skip the folder or rename it.",
      fileFolderConflict: "A folder blocks this incoming file. Skip the file or rename it.",
      skipFolder: "Skip folder",
      renameFolder: "Rename incoming folder",
      labelPath: "Path",
