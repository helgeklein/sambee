  ...
  settings: {
    ...
    userManagement: {
      ...
      editor: {
        ...
        oidcRoleAssignmentLabel: "OIDC role assignment",
        oidcRoleAssignmentHelp: "Optional override for the configured OIDC role",
        oidcRoleAssignmentConfiguredRole: "Use configured role assignment",
