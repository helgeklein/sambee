...
export const EN_TRANSLATIONS = {
  ...
  fileBrowser: {
    ...
    archive: {
      ...
      operationsTitle: "Archive operations",
      operationsDescription: "Recent archive work is retained here while it completes or awaits a decision.",
      operationsRefresh: "Refresh",
      operationsEmpty: "No archive operations yet.",
      operationsLoadError: "Archive operation status could not be loaded.",
      operationCancel: "Cancel",
      operationCancellationRequested: "Cancelling",
      operationKinds: {
