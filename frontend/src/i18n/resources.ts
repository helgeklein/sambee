...
export const EN_TRANSLATIONS = {
  ...
  fileBrowser: {
    ...
    archive: {
      ...
      createPrompt_one: "Create a ZIP archive in <directory>{{directory}}</directory> from 1 selected item.",
      createPrompt_other: "Create a ZIP archive in <directory>{{directory}}</directory> from {{count}} selected items.",
      ...
      extractPrompt: "Extract {{archive}} into this destination directory.",
      ...
      buttonIgnoreMemberError: "Ignore member",
      ...
      collisionDestinationPathLabel: "Destination path",
      ...
      memberErrorResolutionLabel: "Choose a resolution",
      memberErrorChoiceRetry: "Retry this member",
      memberErrorChoiceIgnore: "Ignore this member",
