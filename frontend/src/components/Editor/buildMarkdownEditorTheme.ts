...
import { MARKDOWN_SELECTION_HORIZONTAL_INSET_CSS_VARIABLE } from "../../theme/viewerStyles";
  ...
  return [
    ...
    EditorView.theme({
      ".cm-selectionLayer": {
        width: "100%",
        height: "100%",
        clipPath: `inset(0 var(${MARKDOWN_SELECTION_HORIZONTAL_INSET_CSS_VARIABLE}, 0px))`,
      },
    }),
  ];
}
