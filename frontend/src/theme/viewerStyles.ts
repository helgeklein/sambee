...
export const MARKDOWN_SELECTION_HORIZONTAL_INSET_CSS_VARIABLE = "--sambee-markdown-selection-horizontal-inset";
export const TEXT_SELECTION_HORIZONTAL_INSET_CSS_VARIABLE = "--sambee-text-selection-horizontal-inset";
