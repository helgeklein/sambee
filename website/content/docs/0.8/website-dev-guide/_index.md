...
- Prepare or maintain the website publishing environment.
...
- [Setup and Operations](./setup-and-operations/set-up-cloudflare-pages-publishing/): Configure publishing infrastructure such as Cloudflare Pages and understand what the current website workflow actually deploys.

## Use the Right Guide

- Use this Website Dev Guide for website editing, docs authoring, Hugo theme work, docs tooling, shared website system changes, and website publishing infrastructure.
- Use the [Release Info](../release-info/) guide when you want the published release summary rather than the docs or website implementation details behind it.
