...
SMB connections are managed in Sambee's settings, which are accessible via the gear icon or via the keyboard shortcut <kbd>Ctrl</kbd> + <kbd>,</kbd>.
...
To see and explore the files and folders of an SMB connection, locate the **Connection List** in the main UI and select the desired connection (keyboard shortcut: <kbd>Ctrl</kbd> + <kbd>Down</kbd>).
