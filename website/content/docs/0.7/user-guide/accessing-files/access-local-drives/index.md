...
When Companion is running and paired, local drives appear in the **Connection List** next to SMB connections (keyboard shortcut: <kbd>Ctrl</kbd> + <kbd>Down</kbd>).
...
- If the browser is not paired, pair it with Companion.
